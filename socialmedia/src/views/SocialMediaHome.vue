  ...
  <div class="w3-container socialMedia">
    ...
    <div class="w3-container w3-content contentPage">
      ...
      <div class="w3-row">
        ...
        <!-- Middle Column -->
        <div class="w3-col m7 mainContent">
          <div v-for="post in allPosts" :key="post.id">
            <div v-if="post" class="w3-margin-left w3-round w3-margin-right">
              <div
                class="w3-card w3-white round w3-padding cardComment"
              >
                <div class="w3-half">
                  <img
        ...
        <div class="w3-col m2">
          <div class="w3-card w3-round w3-white">
            ...
            <div v-for="user in users" :key="user.id">
              <div class="flexContainer w3-padding" >
                <img
                  :src="user.avatarUrl"
                  alt="Avatar"
                  class="w3-circle profile"
                />
                <p class="usersName">{{ user.name }}</p>
              </div>
            </div>
          </div>
          </div>
...
export default {
  ...
  methods: {
   getUser(){
      this.isAdmin = this.$options._parentVnode.context.isAdmin;
